...
.DATA
    ...
    ;powers varibles
    IS_POWER_FIRE_DRAW_P1         DB 1h ;varible determined if there are a fire power in player1 Playground to draw it if 1 draw it if 0 don't draw, it will be (1) after M seconds 
    ...
    IS_POWER_FIRE_DRAW_P2         DB 1h ;varible determined if there are a fire power in player2 Playground to draw it if 1 draw it if 0 don't draw, it will be (1) after M seconds 
